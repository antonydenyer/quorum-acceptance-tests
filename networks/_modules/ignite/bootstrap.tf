    ...
    "alloc": {
      "0x0000000000000000000000000000000000008888": {
        ...
        "storage" : {
          ...
          %{for idx, address in quorum_bootstrap_node_key.nodekeys-generator[*].istanbul_address ~}
                %{if tonumber(idx) < local.number_of_nodes - 1~}
                  "0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e56${3 + tonumber(idx)}": "0x000000000000000000000000${trimprefix(address, "0x")}",
                %{else~}
                  "0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e56${3 + tonumber(idx)}": "0x000000000000000000000000${trimprefix(address, "0x")}"
                %{endif}
          %{endfor~}
